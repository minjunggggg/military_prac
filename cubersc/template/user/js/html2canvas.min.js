            ...
            4: [
                function (n, f) {
                    function o(e, n) {
                        ...
                        if (
                            ((n = n || {}),
                            n.logging && ((v.options.logging = !0), (v.options.start = Date.now())),
                            ...
                            return (
                                (o =
                                    "view" === f.type
                                        ...
                                        : e === i.document.body || e === i.document.documentElement || null != f.canvas
                                        ? g.canvas
                                        : l(g.canvas, {
                        ...
                        this.promise = (
                            f
                                ? new Promise(function (e) {
                                      "about:blank" === n.contentWindow.document.URL || null == n.contentWindow.document.documentElement
                ...
                function (e, n) {
                    ...
                    (f.prototype.findImages = function (e) {
                        ...
                        (f.prototype.fetch = function (e) {
                            return (
                                (this.images = e.reduce(c(this.findBackgroundImage, this), this.findImages(e))),
                ...
                function (e, n) {
                    ...
                    (f.prototype.cloneTo = function (e) {
                        ...
                        (f.prototype.parseBackgroundSize = function (e, n, f) {
                            ...
                            return (
                                (d = "auto" === t[0] && "auto" === t[1] ? n.height : "auto" === t[1] ? (o / n.width) * n.height : i(t[1]) ? (e.height * parseFloat(t[1])) / 100 : parseInt(t[1], 10)),
                        ...
                        (f.prototype.parseBackgroundPosition = function (e, n, f, o) {
                            ...
                            return (
                                (d = i(l[0]) ? (e.width - (o || n).width) * (parseFloat(l[0]) / 100) : parseInt(l[0], 10)),
                            ...
                            var n,
                                ...
                                c = function () {
                                    n &&
                                        ...
                                        f && l.push(f),
                                        "-" === n.substr(0, 1) && (d = n.indexOf("-", 1) + 1) > 0 && ((o = n.substr(0, d)), (n = n.substr(d))),
                                        u.push({
                                            prefix: o,
